		...
		<div class="row">
			<div class="col-sm-6 col-md-4 col-md-offset-4">
				...
				<div class="account-wall">
					<img class="profile-img" src="https://upload.wikimedia.org/wikipedia/id/thumb/c/c4/Telkom_Indonesia_2013.svg/1280px-Telkom_Indonesia_2013.svg.png"
					alt="">
					<form class="form-signin" method="POST" action="<?php echo base_url() ?>index.php/login">
						...
						<a href="#" class="pull-right need-help">Butuh bantuan? </a>
