                ...
                <div class="panel panel-default">
                    <div classs="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-cog"></i> Edit Database</h3>
                    </div>
                    <div class="panel-body">
                        <?php
                        if(!empty($data_alert_editDB)){
                        ...
                        foreach($data_edit as $daed){
                        echo form_open('list_database/process_updateDB', $form_attr);
                        echo form_hidden('id_db', $daed->id_db);
                        ?>
                        <div class="form-group">
                            ...
                            $ipt_hostname_attr = array('class' => 'form-control', 'id' => 'hostname'
                                , 'name' => 'hostname', 'placeholder' => 'Ex: 127.0.0.1',
                                 'maxlength' => '15', 'value' => $daed->hostname);
                        ...
                        <div class="form-group">
                            ...
                            $ipt_username_attr = array('class' => 'form-control', 'id' => 'username'
                                ...
                                'maxlength' => '50', 'value' => $daed->username);
                        ...
                        <div class="form-group">
                            ...
                            $ipt_passwd_attr = array('class' => 'form-control', 'id' => 'password'
                                , 'name' => 'password', 'value' => $daed->password);
                        ...
                        <div class="form-group">
                            ...
                            $ipt_database_attr = array('class' => 'form-control', 'id' => 'database'
                                , 'name' => 'database', 'placeholder' => 'Ex: ci-magang',
                                 'maxlength' => '50', 'value' => $daed->name_database);
